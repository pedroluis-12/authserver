...
import br.pucpr.authserver.books.BookRepository
...
class LoanService(
    ...
    fun insert(data: CreateLoanRequest): Loan {
        log.info("Creating loan for book ID: {}", data.bookId)
    ...
    fun findAll(
        ...
        log.info("Searching for loans with bookTitle: {}, loanDate: {}, returnDate: {}", bookTitle, loanDate, returnDate)
